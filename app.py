...
def register():
    if request.method == 'POST':
        ...
        response.set_cookie('registration_success', 'true', httponly=True)  # Set an additional HttpOnly cookie
...
def login():
    if request.method == 'POST':
        ...
        if user and user.check_password(password):
            ...
            response.set_cookie('login_success', 'true', httponly=True, secure=True, samesite='Lax')
